...
if __name__ == "__main__":
    ...
    parser.add_argument('--analysis_ids', required=True, default=None, type=str, help='analysis ids')
    ...
    for analysis_id in fp:
        ...
        if not os.path.isdir(workdir):
            pipelineUtil.download_from_cleversafe(None, args.bucket, analysis_id, workdir)
        ...
        if os.path.isdir(workdir):
            ...
            star_log_out = os.path.join(args.bucket, 'lung', 'logs', '%s.log' %analysis_id)
