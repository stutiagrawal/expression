...
def run_pipeline(args, workdir, analysis_id, logger):
    ...
    cuffout_genes_remote = os.path.join(args.bucket, "cufflinks", "star_gene_new_ref", "%s.genes.fpkm_tracking" %analysis_id)
    ...
    cuffout_isoforms_remote = os.path.join(args.bucket, "cufflinks", "star_iso_new_ref", "%s.isoforms.fpkm_tracking" %analysis_id)
...
if __name__ == "__main__":
    ...
    if os.path.isdir(workdir):
        ...
        star_log_out = os.path.join(args.bucket, 'ov', 'logs', '%s.log' %analysis_id)
